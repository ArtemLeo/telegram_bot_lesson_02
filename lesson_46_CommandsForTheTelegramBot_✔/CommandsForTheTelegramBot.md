...
[
  ...
  {
    "name": "Frozen",
    "description": "Пригоди сміливої принцеси Анни, яка вирушає в небезпечну подорож разом з крижаним продавцем Кристофом, його вірним оленем Свеном і сніговиком Олафом, щоб знайти свою сестру Ельзу, чиї крижані сили засудили королівство вічній зимі.",
    "rating": 7.4,
  ...
  {
    "name": "The Lion King",
    "description": "Історія про молодого лева Сімби, який має стати королем савани після смерті свого батька Муфаси. Проте його дядько Шрам має інші плани і вбиває Муфасу, щоб захопити владу. Сімба вирушає у вигнання, де знаходить нових друзів, які допомагають йому повернутися і відвоювати своє королівство.",
    "rating": 8.5,
